...
import com.example.jet_ecommerce.ui.components.CategoryWidget
...
@Composable
fun RenderCategoriesStates(viewModel: HomeViewModel = hiltViewModel(), navController: NavHostController) {
