...
import com.example.jet_ecommerce.ui.components.SearchField
...
fun RenderViewState(vm: CategoriesViewModel, navController: NavHostController) {
    ...
    when (states) {
        is CategoriesContract.State.Error -> ShowError((states as CategoriesContract.State.Error).message)
        is CategoriesContract.State.Loading -> ShowLoading()
        is CategoriesContract.State.Success -> ShowCategoriesList(
            (states as CategoriesContract.State.Success).categories,
            subCategoriesList,
            onCategoryItemClick = {
        ...
        Column(verticalArrangement = Arrangement.SpaceBetween) {
            ...
            Row(
                ...
                SearchField(
                    modifier = Modifier
                        .padding(top = 16.dp)
                        .fillMaxWidth(0.9F),
                    placeholderText = "What do you search for?"
                )
            ...
            Row(
                ...
                Column(
                    ...
                    ShowSubCategoriesList(category, subCategoriesList) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Box(
            ...
            AsyncImage(
                modifier = Modifier
                    .fillMaxSize(),
                model = category.image, contentDescription = "Category image",
            ...
            TextButton(modifier = Modifier
                .padding(start = 14.dp, top = 6.dp, end = 24.dp, bottom = 6.dp)
